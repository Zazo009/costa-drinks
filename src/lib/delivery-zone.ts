...
export const DELIVERY_TOWNS: DeliveryTown[] = [
  { id: 'estepona', name: { en: 'Estepona', es: 'Estepona' }, offsetKm: -28 },
  { id: 'cancelada', name: { en: 'Cancelada', es: 'Cancelada' }, offsetKm: -20 },
  ...
  { id: 'elviria', name: { en: 'Elviria', es: 'Elviria' }, offsetKm: 10 },
  { id: 'cabopino', name: { en: 'Cabopino', es: 'Cabopino' }, offsetKm: 14 },
  { id: 'calahonda', name: { en: 'Calahonda', es: 'Calahonda' }, offsetKm: 18 },
];
